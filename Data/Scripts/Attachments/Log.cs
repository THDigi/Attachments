...
namespace Digi.Utils
{
    ...
    {
        public const string MOD_NAME = "Attachments";
        public const string MOD_FOLDER = MOD_NAME; // optional: if scripts folder name is different than the mod name
        public const int WORKSHOP_ID = 516770964;
